    ...
    switch ($_GET['action']) {
        ...
        case 'chmod':
            ...
            if (
				...
				<form id="chmod_form">
					<table class="table striped hovered cell-hovered border bordered text-center file-perms-table">
						<thead>
							<tr>
								<td></td>
						...
						<tbody>
							<tr>
								<td class="text-left"><span class="mif-user mif-lg fg-gray"></span> ' . trans('User') . '</td>
								<td><label class="input-control checkbox"><input id="u_4" type="checkbox" data-value="4" data-group="user" ' . (chmod_logic_helper($perm_user, 4) ? " checked" : "") . '><span class="check"></span></label></td>
								<td><label class="input-control checkbox"><input id="u_2" type="checkbox" data-value="2" data-group="user" ' . (chmod_logic_helper($perm_user, 2) ? " checked" : "") . '><span class="check"></span></label></td>
								<td><label class="input-control checkbox"><input id="u_1" type="checkbox" data-value="1" data-group="user" ' . (chmod_logic_helper($perm_user, 1) ? " checked" : "") . '><span class="check"></span></label></td>
							</tr>
							<tr>
								<td class="text-left"><span class="mif-users mif-lg fg-gray"></span> ' . trans('Group') . '</td>
								<td><label class="input-control checkbox"><input id="g_4" type="checkbox" data-value="4" data-group="group" ' . (chmod_logic_helper($perm_group, 4) ? " checked" : "") . '><span class="check"></span></label></td>
								<td><label class="input-control checkbox"><input id="g_2" type="checkbox" data-value="2" data-group="group" ' . (chmod_logic_helper($perm_group, 2) ? " checked" : "") . '><span class="check"></span></label></td>
								<td><label class="input-control checkbox"><input id="g_1" type="checkbox" data-value="1" data-group="group" ' . (chmod_logic_helper($perm_group, 1) ? " checked" : "") . '><span class="check"></span></label></td>
							</tr>
							<tr>
								<td class="text-left"><span class="mif-flow-tree mif-lg fg-gray"></span> ' . trans('All') . '</td>
								<td><label class="input-control checkbox"><input id="a_4" type="checkbox" data-value="4" data-group="all" ' . (chmod_logic_helper($perm_all, 4) ? " checked" : "") . '><span class="check"></span></label></td>
								<td><label class="input-control checkbox"><input id="a_2" type="checkbox" data-value="2" data-group="all" ' . (chmod_logic_helper($perm_all, 2) ? " checked" : "") . '><span class="check"></span></label></td>
								<td><label class="input-control checkbox"><input id="a_1" type="checkbox" data-value="1" data-group="all" ' . (chmod_logic_helper($perm_all, 1) ? " checked" : "") . '><span class="check"></span></label></td>
							</tr>
							<tr>
								<td></td>
								<td colspan="3"><div class="input-control text info"><input type="text" class="input-block-level text-center" name="chmod_value" id="chmod_value" value="' . $perm . '" data-def-value="' . $perm . '"></div></td>
							</tr>
						</tbody>
					</table>';
            ...
            if ($sub_action == 'preview') {
                if ($preview_mode == 'text') {
                    ...
                    if (!in_array($info['extension'], $previewable_text_file_exts_no_prettify)) {
                        ...
                        $ret .= '<script src="https://cdn.rawgit.com/google/code-prettify/master/loader/run_prettify.js?lang=' . $info['extension'] . '"></script>';
                        $ret .= '<div class="text-center"><strong>' . $info['basename'] . '</strong></div><pre class="prettyprint linenums">' . $data . '</pre>';
                    } else {
