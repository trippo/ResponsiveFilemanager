...
define('lang_Upload_base_help',"Drag & Drop files or click in above area (for modern browsers), otherwise select the file and click button. When the upload will end, click on return button.");
