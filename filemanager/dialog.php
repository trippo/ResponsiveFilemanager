...
//filter
    ...
    ?>
        ...
        <body>
            ...
            <input type="hidden" id="lang_preview" value="<?php echo trans('Preview'); ?>" />
            <input type="hidden" id="lang_info" value="<?php echo trans('Info'); ?>" />
            <input type="hidden" id="lang_about" value="<?php echo trans('About'); ?>" />
...
// Should lazy loading be enabled
                ...
                <div class="app-bar fixed-top navy rfm" data-role="appbar" data-flexclean="true">
                    <div class="containerx filters">
                        <a href="/" class="app-bar-element branding"> Responsive File Manager</a>
                        <div class="app-bar-divider"></div>
                        <ul class="app-bar-menu">

                            <?php if ($upload_files) { ?>
                                <li> 
                                    <a class="tip upload-btn bg-transparent" href="javascript:void('')" title="<?php echo trans('Upload_file'); ?>"><i class="icon mif-cloud-upload"></i></a>
                                </li>
                            <?php } ?>

                            <?php if ($create_text_files) { ?>
                                <li>
                                    <a class="tip create-file-btn bg-transparent" href="javascript:void('')" title="<?php echo trans('New_File'); ?>"><i class="icon mif-file-empty"></i></a>
                                </li>
                            <?php } ?>

                            <?php if ($create_folders) { ?>
                                <li>
                                    <a class="tip btn new-folder" href="javascript:void('')" title="<?php echo trans('New_Folder') ?>"><i class="mif-folder-plus"></i></a>
                                </li>
                            <?php } ?>

                            <?php if ($copy_cut_files || $copy_cut_dirs) { ?>
                                <li>
                                    <a class="tip paste-here-btn" href="javascript:void('')" title="<?php echo trans('Paste_Here'); ?>" data-hotkey="alt+v"><i class="mif-clipboard"></i></a>
                                </li>

                                <li>
                                    <a class="tip clear-clipboard-btn" href="javascript:void('')" title="<?php echo trans('Clear_Clipboard'); ?>"><i class="mif-cancel"></i></a>
                                </li>
                            <?php } ?>

                        </ul>

                        <ul class="app-bar-menu view-controller">
                            <li class="divider"></li>

                            <li class="<?php if ($view == 0) echo "active"; ?>">
                                <a href="javascript:void('')" id="view0" data-value="0" title="<?php echo trans('View_boxes'); ?>"><i class="mif-apps <?php if ($view == 0) echo "icon-white"; ?>"></i></a>                         
                            </li>
                            <li class="<?php if ($view == 1) echo "active"; ?>">                  
                                <a href="javascript:void('')" id="view1" data-value="1" title="<?php echo trans('View_list'); ?>"><i class="mif-list <?php if ($view == 1) echo "icon-white"; ?>"></i></a>                           
                            </li>
                            <li class="<?php if ($view == 2) echo "active"; ?>">
                                <a href="javascript:void('')" id="view2" data-value="2" title="<?php echo trans('View_columns_list'); ?>"><i class="mif-columns <?php if ($view == 2) echo "icon-white"; ?>"></i></a>
                            </li>
                            <li class="divider"></li>

                        </ul>

                        <ul class="app-bar-menu small-dropdown place-right" id="showLinksWrap">
                            <li class="divider"></li>
                            <li><a href="javascript:void('')" id="showLinks"><span class="mif-more-vert"></span></a></li>

                            <li class="actionx"><a id="refresh" class="" href="dialog.php?<?php echo $get_params . $subdir . "&" . uniqid() ?>"><i class="mif-loop2"></i></a></li>
                            <li class="actionx"><a class="" href="javascript:void('')" id="change_lang_btn"><i class="mif-earth"></i></a></li>
                            <li class="actionx"> <a class="" href="javascript:void('')" id="info"><i class="mif-question"></i></a></li>
                            <li class="divider"></li>
                        </ul>

                        <ul class="app-bar-menu place-right">     
                            <li class="divider"></li>
                            <li><a href="javascript:void('')" id="showFilters"><span class="mif-filter"></span></a></li>                        
                            <?php if ($_GET['type'] != 1 && $_GET['type'] != 3) { ?>
                                <li class="filterx">
                                    <input id="select-type-1" name="radio-sort" type="radio" data-item="ff-item-type-1" checked="checked"  class="no-display" />
                                    <label id="ff-item-type-1" title="<?php echo trans('Files'); ?>" for="select-type-1" class="tip ff-label-type-1"><i class="mif-files-empty"></i></label>                                       
                                </li>
                                <li class="filterx">
                                    <input id="select-type-2" name="radio-sort" type="radio" data-item="ff-item-type-2" class="no-display"  />
                                    <label id="ff-item-type-2" title="<?php echo trans('Images'); ?>" for="select-type-2" class="tip ff-label-type-2"><i class="mif-file-picture"></i></label>
                                </li>
                                <li class="filterx">                                        
                                    <input id="select-type-3" name="radio-sort" type="radio" data-item="ff-item-type-3" class="no-display"  />
                                    <label id="ff-item-type-3" title="<?php echo trans('Archives'); ?>" for="select-type-3" class="tip ff-label-type-3"><i class="mif-file-archive"></i></label>
                                </li>
                                <li class="filterx">
                                    <input id="select-type-4" name="radio-sort" type="radio" data-item="ff-item-type-4" class="no-display"  />
                                    <label id="ff-item-type-4" title="<?php echo trans('Videos'); ?>" for="select-type-4" class="tip ff-label-type-4"><i class="mif-film"></i></label>
                                </li>
                                <li class="filterx">

                                    <input id="select-type-5" name="radio-sort" type="radio" data-item="ff-item-type-5" class="no-display"  />
                                    <label id="ff-item-type-5" title="<?php echo trans('Music'); ?>" for="select-type-5" class="tip ff-label-type-5"><i class="mif-file-music"></i></label>
                                </li>
                            <?php } ?>


                            <li class="filterx" style="width: 110px;max-width:110px!important;">
                                <div class="input-control text" id="filter-inputWrap">
                            ...
                            <li class="filterx">
                                <input id="select-type-all" name="radio-sort" type="radio" data-item="ff-item-type-all" class="no-display"  />
                                <label id="ff-item-type-all" title="<?php echo trans('All'); ?>" <?php if ($_GET['type'] == 1 || $_GET['type'] == 3) { ?>style="visibility: hidden;" <?php } ?> data-item="ff-item-type-all" for="select-type-all" class="tip ff-label-type-all"><i class="mif-cross"></i></label>

                            </li>                         
                        </ul>

                        <span class="app-bar-pull automatic"></span>
                ...
                <div class="grid condensed no-margin">
                    <div class="row">
                        ...
                        <ul class="breadcrumbs dark">
                            <li><a href="<?php echo $link ?>/"><span class="icon mif-home"></span></a></li>                    
                            <?php
                            $bc = explode("/", $subdir);
                            $tmp_path = '';
                            if (!empty($bc))
                        ...
                        <ul class="dark no-split">
                            <li class="fg-white">

                                <span id="files_number"><span class="mif-files-empty"></span> <?php echo $current_files_number ?></span>



                                <span id="folders_number"><span class="mif-folder-open"></span> <?php echo $current_folders_number ?></span>

                            </li>
                            <li>
                                <div class="dropdown-button place-right" style="display: inline-block;">
                                    <button class="button dropdown-toggle sorting-btn"><span class="mif-sort-asc"></span></button>
                                    <ul class="split-content d-menu place-right sorting" data-role="dropdown" data-no-close="true">
                                        <li class="text-center menu-title"><strong><?php echo trans('Sorting') ?></strong></li>
                                        <li><a class="sorter sort-name <?php
                                            if ($sort_by == "name") {
                                                echo ($descending) ? "descending" : "ascending";
                                            }
                                            ?>" href="javascript:void('')" data-sort="name"><span class="indicator"></span> <?php echo trans('Filename'); ?></a></li>
                                        <li><a class="sorter sort-date <?php
                                            if ($sort_by == "date") {
                                                echo ($descending) ? "descending" : "ascending";
                                            }
                                            ?>" href="javascript:void('')" data-sort="date"><span class="indicator"></span> <?php echo trans('Date'); ?></a></li>
                                        <li><a class="sorter sort-size <?php
                                            if ($sort_by == "size") {
                                                echo ($descending) ? "descending" : "ascending";
                                            }
                                            ?>" href="javascript:void('')" data-sort="size"><span class="indicator"></span> <?php echo trans('Size'); ?></a></li>
                                        <li><a class="sorter sort-extension <?php
                                            if ($sort_by == "extension") {
                                                echo ($descending) ? "descending" : "ascending";
                                            }
                                            ?>" href="javascript:void('')" data-sort="extension"><span class="indicator"></span> <?php echo trans('Type'); ?></a></li>
                ...
                <div class="row-fluid ff-container">
                    <div class="span12">
                        ...
                        <?php } else { ?>
                            ...
                            <ul class="grid grid-main cs-style-2 <?php echo "list-view" . $view; ?>" id="main-item-container">
                                <?php
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <figcaption>
                                                    <a href="javascript:void('')" class="tip-left edit-button rename-file-paths <?php if ($rename_folders && !$file_prevent_rename) echo "rename-folder"; ?>" title="<?php echo trans('Rename') ?>" data-path="<?php echo $rfm_subfolder . $subdir . $file; ?>">
                                                        <i class="mif-pencil <?php if (!$rename_folders || $file_prevent_rename) echo 'icon-white'; ?>"></i></a>
                                                    <a href="javascript:void('')" class="tip-left erase-button <?php if ($delete_folders && !$file_prevent_delete) echo "delete-folder"; ?>" title="<?php echo trans('Erase') ?>" data-confirm="<?php echo trans('Confirm_Folder_del'); ?>" data-path="<?php echo $rfm_subfolder . $subdir . $file; ?>" >
                                                        <i class="mif-bin <?php if (!$delete_folders || $file_prevent_delete) echo 'icon-white'; ?>"></i>
                                                    </a>
                                                </figcaption>
                                            <?php } ?>
                                        </figure>
                                            ...
                                            ?>">
                                                ...
                                                <figcaption>
                                                    <form action="force_download.php" method="post" class="download-form" id="form<?php echo $nu; ?>">
                                                        ...
                                                        <a title="<?php echo trans('Download') ?>" class="tip-right" href="javascript:void('')" onclick="$('#form<?php echo $nu; ?>').submit();"><i class="mif-cloud-download"></i></a>
                                                        <?php if ($is_img && $src_thumb != "" && $extension_lower != "tiff" && $extension_lower != "tif") { ?>
                                                            <a class="tip-right preview" title="<?php echo trans('Preview') ?>" data-url="<?php echo $src; ?>"><i class=" mif-eye"></i></a>
                                                        <?php } elseif (($is_video || $is_audio) && in_array($extension_lower, $jplayer_ext)) { ?>
                                                            ...
                                                            ?>"
                                                               ...
                                                               href="javascript:void('');" ><i class=" mif-eye"></i></a>
                                                           ...
                                                           <?php } elseif ($googledoc_enabled && in_array($extension_lower, $googledoc_file_exts)) { ?>
                                                            <a class="tip-right file-preview-btn" title="<?php echo trans('Preview') ?>" data-url="ajax_calls.php?action=get_file&sub_action=preview&preview_mode=google&title=<?php echo $filename; ?>&file=<?php echo $current_path . $rfm_subfolder . $subdir . $file; ?>"
                                                               href="docs.google.com;" ><i class=" mif-eye"></i></a>
                                                        ...
                                                        <?php } else { ?>
                                                            <a class="preview disabled"><i class="mif-eye fg-gray"></i></a>
                                                        <?php } ?>
                                                        <a href="javascript:void('')" class="tip-left edit-button rename-file-paths <?php if ($rename_files && !$file_prevent_rename) echo "rename-file"; ?>" title="<?php echo trans('Rename') ?>" data-path="<?php echo $rfm_subfolder . $subdir . $file; ?>">
                                                            <i class="mif-pencil <?php if (!$rename_files || $file_prevent_rename) echo 'icon-white'; ?>"></i></a>
                                                        ...
                                                        <a href="javascript:void('')" class="tip-left erase-button <?php if ($delete_files && !$file_prevent_delete) echo "delete-file"; ?>" title="<?php echo trans('Erase') ?>" data-confirm="<?php echo trans('Confirm_del'); ?>" data-path="<?php echo $rfm_subfolder . $subdir . $file; ?>">
                                                            <i class="mif-bin <?php if (!$delete_files || $file_prevent_delete) echo 'icon-white'; ?>"></i>
                                                        </a>
                                                    </form>
                                                </figcaption>
                                            </figure>
    ...
    <?php endforeach; ?>
        ...
        <?php if ($upload_files) { ?>
            <!-- uploader div start -->
            <div data-role="dialog" id="uploadDialog" data-windows-style="true" data-overlay="true" data-overlay-color="op-dark" class="window-style">
                <div class="container page-content">                
                    <h1 class="text-light"><span class="mif-cloud-upload"></span> <?php echo trans('Upload_file'); ?></h1>
                    <hr class="thin"/>
                    <div class="text-center">
                        <button class="button info close-uploader"><i class="mif-arrow-left"></i> <?php echo trans('Return_Files_List') ?></button>
                    </div>

                    <div class="tabcontrol2" data-role="tabControl"> <!-- Only required for left/right tabs -->

                        <ul class="tabs">
                            <li class="active"><a href="#uploadTab" data-toggle="tab"><?php echo trans('Upload_base'); ?></a></li>
                            <?php if ($java_upload) { ?>
                                <li><a href="#tab2" id="uploader-btn" data-toggle="tab"><?php echo trans('Upload_java'); ?></a></li>
                            <?php } ?> 
                        </ul>
                        <div class="frames">
                            <div class="frame" id="uploadTab">
                                ...
                                <form action="dialog.php" method="post" enctype="multipart/form-data" id="rfmDropzone" class="dropzone">
                                    ...
                                    <span class="mif-cloud-upload fg-cyan mif-ani-hover-bounce"></span>
                                </form>

                                <h3><small><?php echo trans('Upload_base_help'); ?></small></h3>
                            </div>
                            <?php if ($java_upload) { ?>
        ...
        <!-- dialogs div start -->        
        <div data-role="dialog" id="dcmDialog" data-windows-style="true" data-overlay="true" data-overlay-color="op-dark" class="window-style">
            <div class="container page-content" id="dcmDialog-content">                
        ...
        <div data-role="dialog" id="previewLightbox" data-windows-style="true" data-overlay="true" data-overlay-color="op-dark" data-close-button="true" class="window-style text-center">
            <div class="grid">
                <div class="row">
        ...
        <div data-role="dialog" id="previewAV" data-windows-style="true" data-overlay="true" data-overlay-color="op-dark" class="window-style">
            <div class="gridx">
                <div class="row">
                    <div class="cell" style="margin: auto;float: none;">
                        <div class="container page-content">                 
                            <h1 class="text-light"><span class="mif-audio preview_icon"></span> <?php echo trans('Preview'); ?> <span id="preview_name"></span></h1>
                            <hr class="thin">
                            <br>
                            ...
                            <div class="form-actions page-content align-right">                        
                                <button type="button" class="button primary" onclick="ocultDialog2('#previewAV', true)"><?php echo trans('Close'); ?></button>                        
                            </div>
                        </div>
        ...
        <!-- player div end -->
        <img id='aviary_img' src='' class="no-display"/>
