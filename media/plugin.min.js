...
tinymce.PluginManager.add('media', function(editor, url) {
    ...
    function openmanager(types) {
        ...
        win = editor.windowManager.open({
            ...
            data: data,
            classes: 'filemanager',
            file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?type=' + types + '&editor=' + editor.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder,
            filetype: 'file',
            width: 900,
            height: 600,
            inline: 1
	...
	function showDialog() {
		...
		win = editor.windowManager.open({
            ...
            direction: 'row',
				items: [
                	{name: 'source1', type: 'textbox', filetype: 'media', size: 35, autofocus: true, classes: 'video3_' + editor.id},
            ...
            direction: 'row',
				items: [
					{name: 'source2', type: 'textbox', filetype: 'media', size: 35, classes: 'video4_' + editor.id},
            ...
            direction: 'row',
				items: [
					{name: 'poster', type: 'textbox', filetype: 'image', size: 35, classes: 'video5_' + editor.id},
